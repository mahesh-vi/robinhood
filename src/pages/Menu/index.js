                ...
                <View style={{ marginHorizontal: 20, marginVertical: 15, }}>
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <View style={{ marginLeft: 20 }}>
                            ...
                            <Text style={[StyleApp.headerSubText]}>Navigate the App from the menu</Text>
                        </View>
                    </View>
...
const styles = StyleSheet.create({
    ...
    menuItem: {
        marginVertical: 10, height: 75, justifyContent: 'center'
    },
    menuItemText: {
    ...
    oval: {
        backgroundColor: "#eaeaea", width: 30, borderRadius: 15, height: 30, marginRight: 30
    }
