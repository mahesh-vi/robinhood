...
export default class MyAchivement extends Component {
    ...
    UNSAFE_componentWillMount = () => {
        ...
        Userservice.achivements().then((res) => {
    ...
    renderItem(item) {
        ...
        return (
            <View >
                <Image source={{ uri: `${achivement}` }} style={{ marginVertical: 10, height: 150, width: "100%", borderRadius: 5 }} />
            </View>
        )
    }
            ...
            <ScrollView style={styles.mainContainer}>
                ...
                <View style={{ marginHorizontal: 20, marginVertical: 15, }}>
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <Text style={[StyleApp.headerSubText]}>Check all your achivements hear</Text>
                        </View>
                    </View>
                        ...
                        <Fragment>
                            ...
                            <View style={{ flex: 1, marginVertical: 20, flexDirection: 'row', justifyContent: 'space-between' }}>
                                ...
                                <View style={{ flex: 1, backgroundColor: '#efefef', padding: 20, borderRadius: 8, marginHorizontal: 10 }}>
                                    ...
                                    <Text style={[StyleApp.lightFont,StyleApp.darkGrayColor, { fontSize: 24, textAlign: 'center' }]}>{this.state.achivements.total_drive}</Text>
                                </View>
                                <View style={{ flex: 1, backgroundColor: '#efefef', padding: 20, borderRadius: 8, marginHorizontal: 10 }}>

                                    <Text  style={[AppStyle.semiBoldFamily,StyleApp.darkGrayColor,StyleApp.font12, { textAlign: 'center' }]}>Completed Drive</Text>
                                    <Text style={[StyleApp.lightFont,StyleApp.darkGrayColor, { fontSize: 24, textAlign: 'center' }]}>{this.state.achivements.complete_drive}</Text>
                                </View>
                            </View>
                            {
