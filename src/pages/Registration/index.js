...
export default class Registration extends Component {
  ...
  register = () => {
    ...
    if (
      Object.keys(this.validateField()).length == 0 &&
      this.state.agreedTerm
    ) {
      this.setState({loading: true});
      Authentication.register(userDetail, isDonor)
        .then((res) => {
          console.log(res);
          const {data} = res;
          this.storeData(data);
  ...
  storeData = async (data) => {
    try {
      ...
      let token = await AsyncStorage.multiSet([
        ['token', data.api_token || JSON.stringify(true)],
  ...
  validateField() {
    ...
    if (!password || password.trim() == '') {
      ...
      fieldValidationErrors.password =
        'Minimum Password size to be 8 characters.';
    }
    ...
    if (
      ...
      if (password !== password_confirmation) {
        fieldValidationErrors.generalError =
  ...
  render() {
    const volunteerImage =
      !this.state.isDonor && this.state.isDonor !== null
        ? require('../../assets/images/volunteer.png')
        : require('../../assets/images/volunteer-gray.png');
    const donerImage =
      this.state.isDonor && this.state.isDonor !== null
        ? require('../../assets/images/doner.png')
        : require('../../assets/images/doner-gray.png');
      ...
      <ScrollView style={styles.mainContainer}>
        ...
        <View
          ...
          <View style={{marginLeft: 10}}>
            ...
            <Text style={[StyleApp.headerSubText]}>
              Fill the below form to join the army
            </Text>
          </View>
        </View>
            ...
            <TouchableOpacity
              ...
              <Text
                style={{
                  fontFamily: 'Montserrat-SemiBold',
                  fontSize: 14,
                  color: this.state.isDonor ? '#00CE9A' : '#D8D8D8',
                }}>
                Doner
              </Text>
            </TouchableOpacity>
        ...
        <View
          ...
          <TouchableOpacity
            ...
            onPress={() => this.setState({agreedTerm: !this.state.agreedTerm})}>
            <Icon
              size={20}
              color={'black'}
          ...
          <Text
            ...
            By clicking this you agree to our term & conditions
          </Text>
        </View>
        {Object.keys(this.state.formErrors).length == 0 &&
          this.state.agreedTerm == false && (
            <Text style={[AppStyle.errorText, {marginLeft: '10%'}]}>
              You must agree term and conditions
            </Text>
          )}
        ...
        <TouchableOpacity
          ...
          <Text
            style={[AppStyle.buttonText, AppStyle.boldFamily, AppStyle.text12]}>
            LETS GO
          </Text>
        </TouchableOpacity>
        ...
        <View
          ...
          <Text style={{color: '#9B99A9', fontFamily: 'Montserrat-Regular'}}>
