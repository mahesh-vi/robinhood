...
export default class NextFoodDonationList extends Component {
    ...
    getDriveList(filter){
        ...
        DriveService.getNextFoodDonationDrive(filter).then((res) => {
            console.log(res);

            this.setState({
                loading: false, drives: CommonUtil.sortBy(res.data.data, {
                    prop: "date",
                    desc: true,
    ...
    renderEmptyComponent=()=>{
        ...
        return (<View style={[{ flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', borderRadius: 5, margin: 10, padding: 20 }, AppStyle.boxWithShadow]}>
    ...
    render() {
        return (
            <ScrollView style={styles.mainContainer}>
                ...
                <View style={{ marginHorizontal: 20 }}>
                    ...
                    <View style={{ flexDirection: 'row', marginVertical: 10, justifyContent: 'space-between' }}>
                        ...
                        <View style={{ marginLeft: 10 }}>
                            ...
                            <Text style={[StyleApp.headerSubText]}>Check all next donation drives hear</Text>

                        </View>
                        <FeatherIcons name={'filter'} size={25} style={{ alignSelf: 'center',justifyContent:'center' }} onPress={() => this.setState({ showFilter: true })} />
                    </View>
                ...
                <FilterOption showModal={this.state.showFilter} onClose={() => this.setState({ showFilter: false })} onApplyFilter={this.onApplyFilter} />
            </ScrollView>
        );
    }
}
