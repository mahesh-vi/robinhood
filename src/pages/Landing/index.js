  ...
  render() {
    return (
      <View style={styles.mainContainer}>
        <Image
          source={require('../../assets/images/Landing-header.jpg')}
          style={[styles.iconImage]}
          resizeMode={'stretch'}
        />

        <Image
          source={require('../../assets/images/explore_robin.png')}
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <Text
              style={[AppStyle.text12, AppStyle.buttonText, StyleApp.boldFont]}>
              Login
            </Text>
          </TouchableOpacity>
          <Text style={[AppStyle.darkGrayColor, AppStyle.regularFont]}>
