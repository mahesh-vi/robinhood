  ...
  submit = () => {
    try {
      ...
      if (Object.keys(this.validateField()).length == 0) {
        ...
        Authentication.otpVerification(this.state.data.email, otp)
          .then((res) => {
      ...
      <ScrollView style={styles.mainContainer}>
        ...
        <View style={{marginHorizontal: 20, marginVertical: 15}}>
          ...
          <View style={[styles.formContainer]}>
            <Text style={[AppStyle.regularFont, AppStyle.text16, {margin: 20}]}>
            ...
            <TouchableOpacity
              ...
              onPress={this.submit}>
              <Text style={[AppStyle.buttonText, StyleApp.boldFont]}>
                Verify
              </Text>
            </TouchableOpacity>
          </View>
