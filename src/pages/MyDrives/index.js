              ...
              <View
                ...
                <View
                  ...
                  <Text
                    ...
                    {this.state.driveData.total_drive}
                  </Text>
                </View>
                <View
                  style={{
                  ...
                  <Text
                    ...
                    {this.state.driveData.complete_drive}
                  </Text>
                </View>
              </View>
                  ...
                  <TouchableOpacity
                    ...
                    <Text
                      style={[
                        ...
                        AppStyle.text14,
                        {
                          color: this.state.isRecent
                            ? StyleApp.primaryColor.color
                            : null,
                          borderBottomWidth: 2,
                          borderBottomColor: this.state.isRecent
                            ? StyleApp.primaryColor.color
                            : '#fff',
                          paddingVertical: 5,
                        },
