        ...
        return (
            <ScrollView style={styles.mainContainer}>
                ...
                <View style={{ alignItems: 'center', marginTop: 20 }}>
                    <Image source={require(`../../assets/images/post_successfull.jpg`)} style={{ height: 300, width: '80%' }} resizeMode={'stretch'} />
                </View>

                <View style={{ alignItems: 'center', marginTop: 20, alignSelf: 'center' }}>
                     <Text style={[AppStyle.semiBoldFamily, AppStyle.blackColor, { flexWrap: 'wrap', textAlign: 'center' }]}>To create drive at least you need to attend 3 drives first.</Text>
                </View>
                ...
                >
                    <Text style={{ color: '#fff', textTransform: 'uppercase', fontFamily: 'Montserrat-Bold' }}>Near by Drives</Text>
                </TouchableOpacity>
