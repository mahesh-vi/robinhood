      ...
      <View style={{alignItems: 'center', flex: 1}}>
        <Modal
          ...
          <TouchableWithoutFeedback
            ...
            <View
              style={{backgroundColor: 'transparent', height: '35%'}}></View>
          </TouchableWithoutFeedback>
            ...
            <View style={[styles.mainView, AppStyle.boxWithShadow]}>
              ...
              <View style={{marginHorizontal: 20}}>
                <Text
                  ...
                  {'Are you sure you want to remove this robin?'}
                </Text>
                ...
                <View style={{marginVertical: 20}}>
                  <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    <View style={{flexDirection: 'row'}}>
                      <Image
                        source={{uri: `${robin.image_url}`}}
                        style={[{width: 50, height: 50, borderRadius: 25}]}
                      />
                    </View>
                    <View style={{marginLeft: 10}}>
                      <Text
                        style={[AppStyle.blackColor, AppStyle.semiBoldFamily]}>
                        {robin.name}
                      </Text>
                      <View
                        style={{
                        ...
                        <Text
                          ...
                          {robin.complete_drive} Successful Drive
                        </Text>
                      </View>
                    </View>
                  </View>
                ...
                <View style={{marginVertical: 10}}>
                  <Text style={[AppStyle.text14, StyleApp.mediumFont]}>
                    Any Reason if Any? (Optional)
                  </Text>
                  <TextInput
                    style={[
                ...
                <View
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      this.setState({agreedTerm: !this.state.agreedTerm})
                    }>
                    <MaterialIcons
                      size={18}
                  ...
                  <Text
                    ...
                    I want new robin to join this drive
                  </Text>
                </View>
