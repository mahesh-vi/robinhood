...
export default class Notification extends Component {
  ...
  renderItem = (item) => {
    ...
    const privousNotification =
      item.index > 0 ? this.state.notifications[item.index - 1] : item.item;

    let isNotSameMonth =
      item.index == 0 ||
      moment(notification.date).format('MM') !==
        moment(privousNotification.date).format('MM');
          ...
          {isNotSameMonth && (
            <View
              ...
              <Text
                ...
                {moment(notification.date).format('MMMM')}
              </Text>
            </View>
          )}
          <View style={{flexDirection: 'row', backgroundColor: '#fff'}}>
            <View style={{alignItems: 'center', justifyContent: 'center'}}>
              <Text
                ...
                {moment(notification.date).format('ddd')}
              </Text>
              <Text style={[AppStyle.mediumFont, {fontSize: 22}]}>
                {moment(notification.date).format('DD')}
              </Text>
              <Text
                style={[
                  AppStyle.boldFamily,
                ...
                {moment(notification.date).format('MMM')}
              </Text>
            </View>
            ...
            <TouchableOpacity
              style={[
                styles.boxWithShadow,
                {
                  ...
                  borderRadius: 5,
                  borderLeftColor:
                    notification.type_id == 3 || notification.type_id == 5
                      ? '#c02424'
                      : '#74c875',
                },
              ]}
              ...
              <View
                style={{
                  backgroundColor:
                    notification.type_id == 3 ||
                    notification.type_id == 5 ||
                    notification.drive_status == '3'
                      ? '#f8e4e4'
                      : '#edf9f0',
                  borderRadius: 10,
                  paddingHorizontal: 5,
            ...
            <View
              ...
              <View
                ...
                <Text
                  style={[
                    AppStyle.mediumFont,
                    {color: '#74c875', fontSize: 10, marginVertical: 2},
                  ]}>
                  Accepted
                </Text>
              </View>
          ...
          <View style={{flexDirection: 'row'}}>
            ...
            <View style={{marginLeft: 20}}>
              ...
              <Text style={[StyleApp.headerSubText]}>
                Get all your updates over here
              </Text>
            </View>
          </View>
        </View>
