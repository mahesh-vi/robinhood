...
export default class NearByDrives extends Component {
            ...
            try {
                const granted = await PermissionsAndroid.request(
                    PermissionsAndroid.PERMISSIONS.ACCESS_FINE_LOCATION,
                    {
                        ...
                        message:
                            'Robinhood needs access to your location ',
    ...
    renderItem = (item) => {
        ...
        const privousDrive = item.index > 0 ? this.state.nearDrives[item.index - 1] : item.item;
                ...
                <View style={{ marginHorizontal: 20 }}>
                    ...
                    <View style={{ flexDirection: 'row', marginVertical: 10 }}>
                        ...
                        <View style={{ marginLeft: 20 }}>
                            ...
                            <Text style={[StyleApp.headerSubText]}>Check all near by drives hear</Text>
                        </View>
                    </View>
