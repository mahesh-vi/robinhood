    ...
    return (
      <View style={{marginVertical: 10}}>
        <View
          ...
          <Text
            style={[AppStyle.mediumFont, AppStyle.blackColor, AppStyle.text16]}>
            Top Robins
          </Text>
          <Text style={[AppStyle.regularFont, AppStyle.grayColor]}>
            Show More
          </Text>
        </View>
        <ScrollView
          ...
          {this.state.topRobins &&
            this.state.topRobins.map((robin, index) => {
              const robinImage = robin.image_url
                ? {uri: robin.image_url}
