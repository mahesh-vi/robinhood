...
export default class JoinModal extends Component {
    ...
    UNSAFE_componentWillMount = () => {
        ...
        CommonService.getJoinReason().then((res) => {
                    ...
                    <ScrollView style={{ backgroundColor: "#fff" }} >
                        <View style={[styles.mainView, AppStyle.boxWithShadow]}>
                            ...
                            <View style={{ marginHorizontal: 20 }}>
                                <Text style={[AppStyle.mediumFont, AppStyle.blackColor, StyleApp.font24]}>{'Do you want to join this drive?'}</Text>
                                ...
                                <View>
                                    ...
                                    <TouchableOpacity style={[{ marginTop: 10, height: 44, paddingHorizontal: 30, borderRadius: 22, alignItems: 'center', justifyContent: 'center' }, AppStyle.primaryBackgroundColor
                                        ...
                                        onPress={this.onJoin} >
                                        <Text style={{ color: '#fff', textTransform: 'uppercase', fontFamily: 'Montserrat-Bold' }}>Join Drive</Text>
                                    </TouchableOpacity>
