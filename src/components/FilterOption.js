  ...
  validateField() {
    ...
    if (filter.endDate && !filter.startDate) {
      fieldValidationErrors.startDate =
        'Start date require if end date available.';
    }

    if (filter.startDate && filter.endDate) {
      if (
        !moment(moment(filter.startDate).format('YYYY-MM-DD')).isSameOrBefore(
          ...
          <View style={{backgroundColor: 'rgba(0,0,0,0.5)'}}>
            <View style={[styles.mainView]}>
              <View
                ...
                />
                <TouchableOpacity onPress={this.clearFilter.bind(this)}>
                  <Text style={[AppStyle.cyanColor, AppStyle.semiBoldFamily]}>
                    Clear
                  </Text>
                </TouchableOpacity>
              </View>
              ...
              <View style={{marginHorizontal: 20}}>
                ...
                <MaterialPicker
                  ...
                  onChangeText={(item) => {
                    console.log(item);
                    this.setState({
                      filter: Object.assign(this.state.filter, {zone: item}),
                    });
                  }}
                />
                ...
                <View style={{marginVertical: 10}}>
                  <View style={{flexDirection: 'row'}}>
                    ...
                    <Text
                      ...
                      {this.state.filter.robins && +this.state.filter.robins}
                    </Text>
                  </View>
