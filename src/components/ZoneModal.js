...
export default class ZoneModal extends Component {
  ...
  UNSAFE_componentWillUpdate = (props) => {
    ...
    if (!showModal) {
      DriveService.getDriveListOnZone(zoneDetail.zoneId, duration).then(
        (res) => {
  ...
  renderVolunteer = (item) => {
    ...
    return (
      <Image
        key={item.id}
        source={imageUrl}
        style={[styles.avtarImage, {left: -10, zIndex: -10}]}
      />
    );
  };
  ...
  renderItem = (item) => {
    ...
    return (
      <TouchableOpacity
        ...
        onPress={() => this.props.onItemPress(areaDetail)}>
        <View
          style={{
            flex: 1,
            flexDirection: 'row',
          ...
          <View>
            <Image
              source={{uri: `${areaDetail.image_url}`}}
            ...
            <Text
              ...
              {areaDetail.people_serve}
            </Text>
          </View>

          <View style={{marginLeft: 5}}>
            <Text
              style={[AppStyle.mediumFont, {fontSize: 14, marginVertical: 2}]}>
              {areaDetail.name}
            </Text>
          ...
          <Ionicons
            ...
            size={30}
            style={{color: '#4cab83', justifyContent: 'flex-end', right: -20}}
          />
        </View>
      </TouchableOpacity>
    );
    ...
    return (
      <View
        ...
        <Modal
          ...
          <ScrollView
            style={[styles.mainView, {backgroundColor: '#79d0aa'}]}
            ...
            <View style={[{marginTop: 50, alignItems: 'center'}]}>
              <Text
                ...
                {zoneDetail.snapshopDetail.zonedetails.name}
              </Text>
            </View>
            ...
            <View
              ...
              <View
                style={{marginHorizontal: 20, marginTop: 20, borderRadius: 5}}>
                <TextInput
