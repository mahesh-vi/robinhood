...
export const DriveListItem = ({
  ...
  const driveImage =
    drive.image || drive.image_url
      ? {uri: drive.image || drive.image_url}
  ...
  return (
    <View>
      ...
      <TouchableOpacity
        style={[{marginTop: 10, marginLeft: 2, width: '100%'}]}
        onPress={onPress}>
        <View
          style={[
            {
          ...
          <View style={{flex: 1, marginLeft: 10, marginRight: 10}}>
            <Text
              style={[
                ...
                AppStyle.blackColor,
                AppStyle.text14,
                {marginVertical: 2, flexWrap: 'wrap', width: '90%'},
              ]}>
              {drive.name}
            </Text>
            <Text
              style={[
                StyleApp.mediumFont,
                AppStyle.text10,
                {flexWrap: 'wrap', width: '80%', color: '#24253D'},
              ]}
              numberOfLines={2}
              ellipsizeMode="tail">
              {drive.description}
            ...
            <View
              ...
              <Text
                style={[
                  AppStyle.whiteColor,
                  AppStyle.boldFamily,
                  {fontSize: 11, lineHeight: 12, textAlign: 'center'},
                ]}>
                {drive.count_serve}
              </Text>
              <Text
                style={[
                  AppStyle.whiteColor,
                  AppStyle.boldFamily,
                  {fontSize: 7, width: '100%', lineHeight: 10},
                ]}>
                {drive.hasOwnProperty('image') ? 'Joined' : 'Served'}
              </Text>
            </View>
          )}
        </View>
