                ...
                <View>
                    <TouchableOpacity
                        ...
                        <View style={{flexDirection:'row',alignItems:'center'}}> 
                                        <Text style={[AppStyle.regularFont, AppStyle.grayText, AppStyle.text16]}>{label ? label : 'Select' + mode}  </Text>
                    {!this.props.removeIcon && <FeatherIcon name={'chevron-down'} size={25} style={{top:2}} /> }
                                        </View>
                            <Text style={[AppStyle.regularFont,AppStyle.blackColor]}>{date && this.fFormatDateTime(date,mode)}</Text>
            ...
            return (
                (<View>
                    ...
                    <View style={[styles.inputContainer]}>
                        <TouchableOpacity style={[AppStyle.borderWidth2,this.props.style]} onPress={this.datepicker}>
                ...
                {!this.props.removeIcon &&      <FeatherIcon name={'chevron-down'} size={25} style={{top:2}} /> }
                            ...
                            <Text style={[AppStyle.regularFont, AppStyle.grayText]}>{this.state.date && this.fFormatDateTime(this.state.date,mode)}</Text>
                        </TouchableOpacity>
                    </View>
