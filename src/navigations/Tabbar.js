  ...
  return (
    <View style={{
      ...
      <TouchableOpacity style={{ padding: 2 }} onPress={() => {
        ...
        <MaterialCommunityIcons name={'view-grid'} size={30} color={navigation.state.index == 0 ? StyleApp.primaryColor.color : "#666"} />
      </TouchableOpacity>
      <TouchableOpacity style={{ padding: 2 }} onPress={() => {
        navigation.getChildNavigation('Notification').popToTop();
        navigation.navigate('Notification')
      }}>
        <FontAwesome name={'bell-o'} size={30} color={navigation.state.index == 1 ? StyleApp.primaryColor.color : "#666"} />
      </TouchableOpacity>
      ...
      <TouchableOpacity style={{ padding: 2 }} onPress={() => {
        ...
        <MaterialCommunityIcons name={'account-outline'} size={35} color={navigation.state.index == 2 ? StyleApp.primaryColor.color : "#666"} />
      ...
      <TouchableOpacity style={{ padding: 2 }} onPress={() => {
        ...
        <FeatherIcon name={'menu'} size={30} color={navigation.state.index == 3 ? StyleApp.primaryColor.color : "#666"} />
      </TouchableOpacity>
